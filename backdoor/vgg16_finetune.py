...
# print(len(test_dataset))
# exit()
finetune_indices = SubsetRandomSampler(indices[:199])
halftest_indices = SubsetRandomSampler(indices[199:])
...
if __name__ == '__main__':
    path_checkpoint = '/home/josh/bd4auth/backdoor/ckp/VGG16/checkpoint_6_epoch_n_data_80.pkl'
    model = VGG_16()
    ...
    for i in range(100):
        fine_tune(model, 0.000001)
        if (i + 1) % 10 == 0:
            print(f"EPOCH{i}: ", eval_target_net(model, halftest_loader))
